    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        for sequence in x:
            ...
            for head in range(self.num_heads):
                ...
                attention_scores = torch.matmul(q, k.T) / self.scale_factor
